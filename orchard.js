...
// multiply each part of the array by 6.5
...
// add each array together
// convert that number from each array into pounds
// store new number into each new variable

// CODE HERE 

let fujiPounds = 0
for (let i = 0; i < fujiTons.length; i++) {
    fujiPounds += fujiTons.length[i]
}
